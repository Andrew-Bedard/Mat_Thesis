...
for k = 1:generations
    ...
    parfor i = 1:population_size
        score_vec(i) = individual_fitness2(population(i,:), Image_orig, boundary);
    end;
    ...
    if mod(k,im_save_int) == 0
        ...
        [Edge,imtest] = evo_pst_test(population, win_ind, Image_orig, Image_name, k, boundary_name, false);
